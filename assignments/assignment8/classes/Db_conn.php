...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'lsyversen';//this will be your WCC username
      $dbUsr = 'lsyversen';//this will be your WCC username
      $dbPass = '2DxbYbF5gyf5';//this will be the password found in the video.
